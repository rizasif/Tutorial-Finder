...
/**
 * Created by Rizwan Asif on 12/28/2014.
 */
public class SaveData extends SQLiteOpenHelper{
    ...
    // Database Name
    private static final String DATABASE_NAME = "savedCoursesManager";

    // Contacts table name
    private static final String TABLE_COURSES = "savedcourses";
